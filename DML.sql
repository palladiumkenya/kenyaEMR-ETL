...
DELIMITER $$
DROP PROCEDURE IF EXISTS populate_etl_hiv_enrollment$$
CREATE PROCEDURE populate_etl_hiv_enrollment()
BEGIN
...
max(if(et.uuid='a0034eee-1940-4e35-847f-97537a35d05e',e.encounter_id,null)) as encounter_id,
e.creator,
max(if(et.uuid='a0034eee-1940-4e35-847f-97537a35d05e',e.date_created,null)) as date_created,
...
-- max(if(o.concept_id=160641,o.value_text,null)) as substitution_first_line_regimen_date,
-- max(if(o.concept_id=160555,o.value_datetime,null)) as substitution_first_line_regimen_reason ,
-- max(if(o.concept_id=160540,o.value_coded,null)) as substitution_second_line_regimen_date,
-- max(if(o.concept_id=160534,o.value_datetime,null)) as substitution_second_line_regimen_reason,
-- max(if(o.concept_id=160535,o.value_text,null)) as second_line_regimen_change_date,
-- max(if(o.concept_id=161551,o.value_text,null)) as second_line_regimen_change_reason,
...
max(if(et.uuid='a0034eee-1940-4e35-847f-97537a35d05e',e.voided,null)) as voided
from encounter e 
inner join 
(
...
DELIMITER $$
DROP PROCEDURE IF EXISTS populate_etl_laboratory_extract$$
CREATE PROCEDURE populate_etl_laboratory_extract()
BEGIN
...
DELIMITER $$
DROP PROCEDURE IF EXISTS populate_etl_pharmacy_extract$$
CREATE PROCEDURE populate_etl_pharmacy_extract()
BEGIN
...
select 
	...
	max(if(o.concept_id = 1282 and cs.concept_set=1085, cs.concept_set, 0)) as arv_drug, -- arv:1085
	max(if(o.concept_id = 159368, o.value_numeric, null)) as duration,
	max(if(o.concept_id = 1443, o.value_numeric, null)) as dose,
	max(if(o.concept_id = 1444, o.value_numeric, null)) as days_prescribed,
...
where o.voided=0 and o.concept_id in(1282,1732,159368,1443,1444) and e.encounter_type not in (9,13) 
group by o.person_id, encounter_id
...
DELIMITER $$
DROP PROCEDURE IF EXISTS populate_etl_treatment_events$$
CREATE PROCEDURE populate_etl_treatment_events()
BEGIN
insert into kenyaemr_etl.etl_patient_treatment_event(
patient_id,
uuid,
visit_id,
visit_date,
...
DELIMITER $$
DROP PROCEDURE IF EXISTS populate_etl_mch_enrollment$$
CREATE PROCEDURE populate_etl_mch_enrollment()
BEGIN
...
DELIMITER $$
DROP PROCEDURE IF EXISTS populate_etl_mch_antenatal_visit$$
CREATE PROCEDURE populate_etl_mch_antenatal_visit()
BEGIN
...
DELIMITER $$
DROP PROCEDURE IF EXISTS populate_etl_mch_postnatal_visit$$
CREATE PROCEDURE populate_etl_mch_postnatal_visit()
BEGIN
...
DELIMITER $$
DROP PROCEDURE IF EXISTS populate_etl_tb_enrollment$$
CREATE PROCEDURE populate_etl_tb_enrollment()
BEGIN
...
DELIMITER $$
DROP PROCEDURE IF EXISTS populate_etl_tb_follow_up_visit$$
CREATE PROCEDURE populate_etl_tb_follow_up_visit()
BEGIN
...
DELIMITER $$
DROP PROCEDURE IF EXISTS populate_etl_tb_screening$$
CREATE PROCEDURE populate_etl_tb_screening()
BEGIN
...
DELIMITER $$
DROP PROCEDURE IF EXISTS populate_etl_hei_enrolment$$
CREATE PROCEDURE populate_etl_hei_enrolment()
BEGIN
...
DELIMITER $$
DROP PROCEDURE IF EXISTS populate_etl_hei_follow_up$$
CREATE PROCEDURE populate_etl_hei_follow_up()
BEGIN
...
DELIMITER $$
DROP PROCEDURE IF EXISTS populate_etl_mch_delivery$$
CREATE PROCEDURE populate_etl_mch_delivery()
BEGIN
...
--------------- populate etl_patients_booked_today-------------------------
insert into etl_patients_booked_today(
patient_id,
last_tca_date,
last_visit_date,
date_table_created,
...
--------------- populate etl_missed_appointments-------------------------
insert into etl_missed_appointments(
patient_id,
last_tca_date,
last_visit_date,
last_encounter_type,
